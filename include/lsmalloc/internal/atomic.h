...
#if (defined(LSMALLOC_ENABLE_INLINE) || defined(LSMALLOC_ATOMIC_C_))
/******************************************************************************/
/* 64-bit operations. */
#if (LG_SIZEOF_PTR == 3 || LG_SIZEOF_INT == 3)
#  ifdef __GCC_HAVE_SYNC_COMPARE_AND_SWAP_8
LSMALLOC_INLINE uint64_t
...
#elif (defined(LSMALLOC_OSATOMIC))
LSMALLOC_INLINE uint64_t
atomic_add_uint64(uint64_t *p, uint64_t x)
{
